...
<c:forEach items="${qqq.questions}" var="q" varStatus="stat">
           ...
           <div class="div_title_question_all">
            ...
            <div class="div_title_question" id="divTitle1"><span >${q.tname}</span>
           ...
           <div class="div_table_radio_question" id="divquestion3">
            ...
            <ul class="ulradiocheck">
             ...
             <li style="width:99%;">
              <input id="${stat.count}_${stat1.count}" name="${stat.count}" type="radio" value="${option}" >
              <label  >${option}</label>
          ...
          <!--  <div class="errorMessage"></div> -->
           ...
           <div class="div_table_radio_question" id="divquestion3">
            ...
            <ul class="ulradiocheck">
              ...
              <c:forEach items="${q.optionstr}" var="option" varStatus="stat1">
             <li style="width:99%;">
              <input id="${stat.count}_${stat1.count}" name="${stat.count}" type="checkbox" value="${option}" >
              <label  >${option}</label>
           ...
           <div class="div_title_question_all">
            <div class="div_topic_question">${stat.count}.</div>
            <div class="div_title_question" id="divTitle2"><span >${q.tname}</span>
            <span style="color:red;">&nbsp;*</span></div>
            <div style="clear:both;"></div>
           </div>
           <div class="div_table_radio_question" id="divquestion3">
            ...
            <ul class="ulradiocheck">
             <li style="width:99%;">
              <input id="q3_1" name="q3" type="text" >
              <label >ssss</label>
             </li>
        ...
        var qs=new Array()
            $(".div_question").each(function(){
                ...
                if($(this).find("[name='type']").val()==3){
                    /* 填空 */
                    aresult.push($(this).find("[name='q3']").val())
                    aresultjson=JSON.stringify(aresult)
