...
//title 的显示删除和隐藏
  ...
  if('${qqq.questions}'!=""){
	...
	//添加单选
	function addRadio() {
		var question = '<div class="div_question"><input type="hidden" name="type" value="1"><div class="div_title_question_all"><div class="div_topic_question">'+i+'.</div><div class="div_title_question" id="divTitle1"><span contenteditable="true">题目</span> <button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deletequestion(this)">删除</button><span style="color:red">&nbsp;*</span></div><div style="clear:both"></div></div><div class="div_table_radio_question" id="divquestion3"><div class="div_table_clear_top"></div><ul class="ulradiocheck"><li style="width:99%"><input id="q3_${stat1.count}" name="q3" type="radio" value="${option}" disabled><label for="q3_${stat1.count}" contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deleteoption(this)">删除</button></li><li style="width:99%"><input id="q3_${stat1.count}" name="q3" type="radio" value="${option}" disabled><label for="q3_${stat1.count}" contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deleteoption(this)">删除</button></li><li style="width:99%"><input id="q3_${stat1.count}" name="q3" type="radio" value="${option}" disabled><label for="q3_${stat1.count}" contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deleteoption(this)">删除</button></li><button onclick="addradiooption(this)" class="button button-pill button-tiny">添加选项</button><div style="clear:both"></div></ul><div style="clear:both"></div><div class="div_table_clear_bottom"></div></div></div>'
	...
	function addCheckBox() {
		var question = '<div class="div_question"><input type="hidden" name="type" value="2"><div class="div_title_question_all"><div class="div_topic_question">'+i+'.</div><div class="div_title_question" id="divTitle2"><span contenteditable="true">问题</span> <button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deletequestion(this)">删除</button> <span style="color:red">&nbsp;*</span></div><div style="clear:both"></div></div><div class="div_table_radio_question" id="divquestion3"><div class="div_table_clear_top"></div><ul class="ulradiocheck"><li style="width:99%"><input id="q3_${stat1.count}" name="q3" type="checkbox" value="" disabled><label for="q3_${stat1.count}" contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deleteoption(this)">删除</button></li><li style="width:99%"><input id="q3_${stat1.count}" name="q3" type="checkbox" value="" disabled><label for="q3_${stat1.count}" contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display:inline" onclick="deleteoption(this)">删除</button></li><button onclick="addcheckboxoption(this)" class="button button-pill button-tiny">添加选项</button><div style="clear:both"></div></ul><div style="clear:both"></div><div class="div_table_clear_bottom"></div></div></div>'
		$("fieldset").append(question);
		i++;
	...
	function addradiooption(add) {
		$(add).before('<li style="width:99%;"><input  name="q3" type="radio" value="答案" disabled="disabled"> <label  contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display: inline;" onclick="deleteoption(this)">删除</button></li>')
	}
	//添加多选选项
	function addcheckboxoption(add) {
		$(add).before('<li style="width:99%;"><input  name="q3" type="checkbox" value="答案" disabled="disabled"><label  contenteditable="true">答案</label><button name="delete" class="button button-pill button-tiny" style="display: inline;" onclick="deleteoption(this)">删除</button> </li>')
	}
	//删除选项
   ...
   <div id="mainCss">
    <div id="mainInner">
     ...
     <div class="surveydescription" id="ctl00_ContentPlaceHolder1_JQ1_divDec"></div>
	   ...
	   <div class="butelect">
		    <button class="button button-pill button-tiny" onclick="addRadio()">添加单选题</button>
		    <button class="button button-pill button-tiny" onclick="addCheckBox()">添加多选题</button>
		    <button class="button button-pill button-tiny" onclick="addQA()">添加填空题</button>
	   </div>
       ...
       <div class="surveycontent" id="ctl00_ContentPlaceHolder1_JQ1_question">
        <div id="ctl00_ContentPlaceHolder1_JQ1_surveyContent">
         <fieldset class="fieldset" id="fieldset1">
           ...
           <div class="div_title_question_all">
            ...
            <button name="delete" class="button button-pill button-tiny" style="display: inline;"
           ...
           <div class="div_table_radio_question" id="divquestion3">
            ...
            <ul class="ulradiocheck">
             ...
             <button onclick="addradiooption(this)" class="button button-pill button-tiny">添加选项</button>
             <div style="clear:both;"></div>
            </ul>
            <div style="clear:both;"></div>
           ...
           <div class="div_title_question_all">
            <div class="div_topic_question">${stat.count}.</div>
													<div class="div_title_question" id="divTitle2">
														...
														<button name="delete" class="button button-pill button-tiny" style="display: none;"
           ...
           <div class="div_table_radio_question" id="divquestion3">
            ...
            <ul class="ulradiocheck">
             ...
             <li style="width:99%;">
              ...
              <button onclick="addcheckboxoption(this)" class="button button-pill button-tiny">添加选项</button>
             <div style="clear:both;"></div>
            </ul>
            <div style="clear:both;"></div>
            <div class="div_table_clear_bottom"></div>
        ...
        <div id="submit_div" style="padding-top: 6px;clear:both; padding-bottom:10px;">
            <div style="background:#ffffff" align="center">
                <input type="submit" value="立即发起调查" onclick="submit()" class="sumitbutton button button-pill button-giant" style="padding:0 300px; height:60px; line-height:60px; margin:5px auto 50px;font-size:20px"/>
            </div>
         <div style="clear:both;"></div>
        </div>
       </div>
