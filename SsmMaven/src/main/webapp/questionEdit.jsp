	...
	<div id="BS">
					...
					<dl class="user-info pull-left">
						...
						<dd class="spinner-list">
							<a href="javascript:void(0)" class="user-name"><span
								id="ctl01_lblUserName" style="text-align:center">15633706612</span><span
								class="caret"></span></a>
							<ul style="width:100px">
								...
								<li id="ctl01_hrefUpgrade"><a
									href="/register/upgradevip.aspx?upgradeReason=1">升级</a></li>
		...
		<div class="BS-box" style="text-align:left;">
			...
			<form name="aspnetForm" method="post"
				action="myquestionnaires.aspx?randomt=1522760517" id="aspnetForm">
				<div>
				...
				<div id="ctl01_ContentPlaceHolder1_divNotify"
					class="nav-header redbcg">
					<div class="container">
						<div class="prompt-box">
							<div class="prompt-wrapper clearfix">
								重要提醒：请<a href='javascript:void(0);'
									onclick="var d=new Date();var url='/wjx/manage/guanzhu.aspx?t='+d.valueOf();PDF_launch(url,295,315);"
									style='font-size:14px;' class='btn btn-default btn-xs'>绑定微信账号</a>，绑定后可通过微信管理问卷、获得新答卷提醒以及找回密码！
							</div>
						</div>
					</div>
				</div>
								...
								<div id="ctl01_ContentPlaceHolder1_searchPapaer"
									...
									<div class="create-add pull-left">
										...
										<div id="ctl01_ContentPlaceHolder1_divInfo"
											...
											<input name="ctl01$ContentPlaceHolder1$txtName" type="text"
									...
									<a href="/newwjx/manage/deletedquestionnaire.aspx"
								...
								<div id="ctl01_ContentPlaceHolder1_qls" class="survey-list">
										...
										<dt class='item-top'>
											<div class='pull-left'>
												<a
													...
													target='_blank' class='pull-left item-tit' title='为34'>为34</a>
												<div class='pull-left item-id'>ID:21275213</div>
											</div>
									...
									<dl class='survey-items' style='z-index:99;position:relative'>
										<dt class='item-top'>
											<div class='pull-left'>
												<a
													href='https://www.wjx.cn/pq/21075919.aspx?t=636583861167775937'
													target='_blank' class='pull-left item-tit' title='游戏调查'>游戏调查</a>
												<div class='pull-left item-id'>ID:21075919</div>
											</div>
											<div class='pull-right'>
												<div class='pull-left item-draft'>●&nbsp;草稿</div>
												<div class='pull-left item-sheet'>
												...
												<div class='pull-left item-data'>3月03日</div>
												<div class='pull-left item-time'>20:55</div>
											</div>
										</dt>
										<dd class='item-bot'>
											<div class='process-box pull-left'>
												<dl class='process-1 pull-left'>
													<dd class='spinner-list'>
														<a href='/wjx/design/designstart.aspx?activity=21075919'><i
															class='icon design-icon'></i>设计问卷<span class='caret'></span></a>
														<ul>
															<span class='caret-inverted'></span>
															<li><a
																href='/wjx/design/designstart.aspx?activity=21075919'
																title='设计向导'>设计向导</a></li>
															<li><a
																href='/newwjx/design/editquestionnaire.aspx?activity=21075919'
																title='编辑问卷'>编辑问卷</a></li>
															<li><a
																href='/wjx/design/questionnairesettings.aspx?activity=21075919'
																title='问卷设置'>问卷设置</a></li>
															<li><a
																href='/newwjx/join/jqnew.aspx?q=21075919&wg=1&t=636583861167775937'
																title='问卷外观'>问卷外观</a></li>
															<li><a
																href='/wjx/design/sethbaward.aspx?activity=21075919'>红包&奖品</a></li>
														</ul>
													</dd>
												</dl>
												<dl class='process-2 pull-left'>
													<dd class='spinner-list'>
														<a href='/newwjx/design/sendqstart.aspx?activity=21075919'><i
															class='icon recovery-icon'></i>发送问卷<span class='caret'></span></a>
														<ul>
															<span class='caret-inverted'></span>
															<li><a
																href='/newwjx/design/sendqstart.aspx?activity=21075919'
																title='通过QQ、MSN、Email发送给受访者'>链接&二维码</a></li>
															<li><a
																href='/wjx/promote/sendweixin.aspx?activityid=21075919'
																title='微信发送'>微信发送</a></li>
															<li><a
																href='/sample/demand.aspx?activityid=21075919&lst=1&npub=1'
																title='帮您以最低成本采集到需要的数据'>样本服务</a></li>
															<li><a
																href='/wjx/promote/joinbacklist.aspx?activityid=21075919'
																title='填写其他用户的问卷，并邀请他们回填'>互填问卷</a></li>
															<li><a
																href='/wjx/promote/promoteapply.aspx?activityid=21075919'
																title='通过设置积分奖励来回收1000份以内的答卷'>申请推荐</a></li>
														</ul>
													</dd>
												</dl>
												<dl class='process-3 pull-left'>
													<dd class='spinner-list'>
														<a href='/report/21075919.aspx' title='答卷统计分析'><i
															class='icon download-icon'></i>分析&下载<span class='caret'></span></a>
														<ul>
															<span class='caret-inverted'></span>
															<li><a href='/report/21075919.aspx'
																title='查看包含统计分析数据的报告，并可以下载到WORD、PDF '>统计&分析</a></li>
															<li><a
																href='/wjx/activitystat/viewstatsummary.aspx?activity=21075919'
																title='以Excel、CSV格式下载答卷数据（可以导入到SPSS分析'>查看下载答卷</a></li>
															<li><a
																href='/wjx/activitystat/viewurl.aspx?activity=21075919'
																title='包括来源渠道分析，时间段分析以及地理位置分析'>来源分析</a></li>
														</ul>
													</dd>
												</dl>
											...
											<div class='operation-box pull-right'>
												<a href='javascript:void(0);'
													class='pull-left release-items' title='此问卷状态是草稿，点击发布问卷'
													onclick='return statusChange(21075919,"",-1);'><i
													class='icon release-icon'></i>发布</a><a
													href='javascript:void(0)'
													onclick='return copyClick(21075919);'
													class='pull-left copy-items'><i class='icon copy-icon'></i>复制</a><a
													href='javascript:void(0)' class='pull-left cutout-items'
													title='删除此问卷' onclick='deleteClick(21075919);'><i
													class='icon cutout-icon'></i>删除 </a> <a
													href='javascript:void(0)' class='pull-left folder-items'
													onclick='alert("很抱歉，此功能仅对企业版客户提供，请升级！");'> <i
													class='icon folder-icon'></i>文件夹
												</a><a class='pull-left item-remind' href='javascript:void(0)'
													onclick='PDF_launch("/wjx/notify/notify.aspx?activityid=21075919",752,386);'><i
													class='icon remind-icon'></i>提醒</a>
											</div>
										</dd>
									</dl>
					...
					<script>
						...
						function deleteClick(id) {
							if (!confirm("您确认要删除此问卷吗？"))
								return false;
							document.getElementById("ctl01_ContentPlaceHolder1_hfActivity").value = id;
							document.getElementById("ctl01_ContentPlaceHolder1_btnDelete").click();
							return false;
						}
						function copyClick(id) {
							PDF_launch("/wjx/manage/copyq.aspx?activity=" + id, 460, 170);
							return false;
						}
