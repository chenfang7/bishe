...
public class SendMail {
	...
	public static void send(String sendto,String email,String code) throws Exception{
	    ...
	    String myEmailAccount = "gui1tar@163.com";
	    String myEmailPassword = "guitar123.";
	    ...
	    // 收件人邮箱（替换为自己知道的有效邮箱）
	    String receiveMailAccount = sendto;
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String content) throws Exception {
        ...
        message.setFrom(new InternetAddress(sendMail, "XX问卷调查", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "注册人", "UTF-8"));

        // 4. Subject: 邮件主题（标题有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改标题）
        message.setSubject("注册激活邮件", "UTF-8");
