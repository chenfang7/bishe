...
public class UserController {
	...
	public Integer active(@RequestParam String email,@RequestParam String code){
		return userService.userActive(email, code);
	}
}
